    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_next: cn(
          ...
          'h-7 w-7 bg-transparent border-1 border-primary/50 p-0 opacity-60 hover:opacity-100 absolute right-1 [&_svg]:fill-foreground',
          classNames?.button_next,
        ),
        button_previous: cn(
          buttonVariants({ variant: 'ghost' }),
          'h-7 w-7 bg-transparent border-1 border-primary/50 p-0 opacity-60 hover:opacity-100 absolute left-1 [&_svg]:fill-foreground',
